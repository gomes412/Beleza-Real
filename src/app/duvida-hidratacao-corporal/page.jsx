    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.titleContainer}>
          <h1 className={styles.title}>Hidratação corporal?</h1>
        </div>
      </header>
      ...
      <div className={styles.textBox}>
        ...
        <p>
          Ajuda a manter a pele macia, evita ressecamento, fissuras e perda de elasticidade.
        </p>

        <h2>Como fazer:</h2>
        <p>
       Após o banho, com a pele ainda levemente úmida, aplique loção ou creme 
       corporal generoso, focando cotovelos, joelhos, pernas e tronco.
