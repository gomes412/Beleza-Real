    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.titleContainer}>
          <h1 className={styles.title}>Hidratar a pele?</h1>
        </div>
      </header>
      ...
      <div className={styles.textBox}>
        ...
        <p>
          Mantém a barreira cutânea saudável, evita ressecamento,
           flacidez e surgimento de linhas finas.
        </p>

        <h2>Como fazer:</h2>
        <p>
      Após a limpeza, aplique creme ou loção diariamente, 
      preferencialmente manhã e/ou noite, adaptado ao seu tipo de pele.
