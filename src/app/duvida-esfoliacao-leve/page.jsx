    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.titleContainer}>
          <h1 className={styles.title}>Esfoliação leve?</h1>
        </div>
      </header>
      ...
      <div className={styles.textBox}>
        ...
        <p>
          Remove células mortas, deixa a pele mais radiante,
          melhora absorção de produtos e evita poros obstruídos.
        </p>

        <h2>Como fazer:</h2>
        <p>
        Após a limpeza, aplique esfoliante suave, massageando levemente, enxágue e hidrate bem.
        </p>
      </div>
