  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <a href="/todoDia4" className={styles.optionButton}>Todos os Dias</a>
        <a href="/cada7.4" className={styles.optionButton}>A cada 7 dias</a>
        <a href="/cada15.4" className={styles.optionButton}>A cada 15 dias</a>
        <a href="/cada30.4" className={styles.optionButton}>A cada 30 dias</a>
        <a href="/personalizar4" className={styles.optionButton}>Personalize a data</a>
